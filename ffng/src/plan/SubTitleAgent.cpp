...
SubTitleAgent::own_init()
{
    ...
    m_font = NULL;
    m_font = new FFont(Path::dataReadPath("font/font_subtitle.ttf"), 20);
}
//-----------------------------------------------------------------
/**
 * Shift all titles up.
...
//-----------------------------------------------------------------
    void
SubTitleAgent::addFont(const std::string &fontname, FColor *new_color)
{
...
{
    const FColor *color = m_colors->getRes(fontname);
