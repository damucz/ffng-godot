 ...
 */
FRoom::FRoom(int w, int h, const std::string &picture,
 ...
 */
    void
FRoom::setWaves(float amplitude, float periode, float speed)
{
...
//-----------------------------------------------------------------
    void
FRoom::addDecor(Decor *new_decor)
{
 ...
 */
    int
FRoom::addModel(Cube *new_model, Unit *new_unit)
{
 ...
 */
    Cube *
FRoom::getModel(int model_index)
{
    Cube *result = NULL;
 ...
 */
    void
FRoom::nextRound(const InputProvider *input)
{
    if (m_fastFalling) {
        while (beginFall()) {
            finishRound();
 ...
 */
    void
FRoom::playImpact(Cube::eWeight impact)
{
    switch (impact) {
        case Cube::NONE:
            break;
 ...
 */
    bool
FRoom::fallout(bool interactive)
{
    bool wentOut = false;
    Cube::t_models::iterator end = m_models.end();
    for (Cube::t_models::iterator i = m_models.begin(); i != end; ++i) {
 ...
 */
    bool
FRoom::falldown(bool interactive)
{
 ...
 */
    void
FRoom::finishRound(bool interactive)
{
    if (interactive) {
...
//-----------------------------------------------------------------
    void
FRoom::controlEvent(const KeyStroke &stroke)
{
    m_controls->controlEvent(stroke);
}
//-----------------------------------------------------------------
    void
FRoom::controlMouse(const MouseStroke &button)
{
    if (button.isLeft()) {
...
//-----------------------------------------------------------------
const StepCounter *
FRoom::stepCounter() const
{
    return m_controls;
}
//-----------------------------------------------------------------
    void
FRoom::setMoves(const std::string &moves)
{
 ...
 */
    bool
FRoom::beginFall(bool interactive)
{
    prepareRound();
    m_lastAction = Cube::ACTION_NO;
...
//-----------------------------------------------------------------
int
FRoom::getCycles() const
{
    return TimerAgent::agent()->getCycles() - m_startTime;
}
//-----------------------------------------------------------------
    void
FRoom::addSound(const std::string &name, const Path &file)
{
    m_soundPack->addSound(name, file);
}
//-----------------------------------------------------------------
    void
FRoom::playSound(const std::string &name, int volume)
{
 ...
 */
    void
FRoom::setScreenShift(const V2 &shift)
{
    m_view->setScreenShift(shift);
}
//-----------------------------------------------------------------
void
FRoom::changeBg(const std::string &picture)
{
...
//-----------------------------------------------------------------
    void
FRoom::drawOn(SDL_Surface *screen)
{
    m_bg->drawOn(screen);
