...
#else
    m_maskRun = 0xB56300FF;
    m_maskReplay = 0x008484FF;
    m_maskCancel = 0x0000FFFF;
#endif
...
Pedometer::watchCursor()
{
    ...
    if (Rect2i(193 + 64, 141 + 81, 44, 45).has_point(loc))
        m_activeMask = m_maskRun;
    else if (Rect2i(193 + 64 + 44, 141 + 81, 44, 45).has_point(loc))
        m_activeMask = m_maskReplay;
    else if (Rect2i(193 + 64 + 44 + 44, 141 + 81, 44, 45).has_point(loc))
