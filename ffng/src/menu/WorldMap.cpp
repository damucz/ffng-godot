...
#else
    m_maskIntro = 0x000080FF;
    m_maskExit = 0x008080FF;
    m_maskCredits = 0x808000FF;
    m_maskOptions = 0x008000FF;
#endif
...
#else
    Point2 loc(mouseLoc.getX(), mouseLoc.getY());
    if (Rect2i(0, 0, 160, 120).has_point(loc))
        m_activeMask = m_maskIntro;
    else if (Rect2i(m_bg->getW() - 160, 0, 160, 120).has_point(loc))
        m_activeMask = m_maskExit;
    else if (Rect2i(0, m_bg->getH() - 120, 160, 120).has_point(loc))
        m_activeMask = m_maskCredits;
    else if (Rect2i(m_bg->getW() - 160, m_bg->getH() - 120, 160, 120).has_point(loc))
